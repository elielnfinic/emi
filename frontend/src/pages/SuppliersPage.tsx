  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setShowModal(true)}>+ New Supplier</Button>
      </div>
      ...
      <Modal isOpen={showModal} onClose={resetForm} title="New Supplier">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <Button type="submit" loading={createMutation.isPending}>Create Supplier</Button>
          </div>
        </form>
      </Modal>
    </div>
